...
(function (global) {
  ...
  /* Dixon-Coles correction: independent Poissons under-count 0-0 and 1-1
     and over-count 1-0 and 0-1. Only those four cells move. */
  ...
  Model.prototype.lams = function (t, st) {
    var p = this.p, frac = remainingFraction(t, p.profile);
